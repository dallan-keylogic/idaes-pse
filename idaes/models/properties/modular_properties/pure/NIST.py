...
class NIST(object):
    ...
    class cp_mol_liq_comp:
        ...
        def build_parameters(cobj):
            cobj.cp_mol_liq_comp_coeff_A = Var(
                doc="Shomate A parameter for ideal liquid molar heat capacity",
                units=pyunits.J * pyunits.mol**-1 * pyunits.K**-1,
            )
            set_param_from_config(cobj, param="cp_mol_liq_comp_coeff", index="A")

            cobj.cp_mol_liq_comp_coeff_B = Var(
                doc="Shomate B parameter for ideal liquid molar heat capacity",
                units=pyunits.J
                * pyunits.mol**-1
                * pyunits.K**-1
                * pyunits.kiloK**-1,
            ...
            cobj.cp_mol_liq_comp_coeff_C = Var(
                doc="Shomate C parameter for ideal liquid molar heat capacity",
                units=pyunits.J
                * pyunits.mol**-1
                * pyunits.K**-1
                * pyunits.kiloK**-2,
            ...
            cobj.cp_mol_liq_comp_coeff_D = Var(
                doc="Shomate D parameter for ideal liquid molar heat capacity",
                units=pyunits.J
                * pyunits.mol**-1
                * pyunits.K**-1
                * pyunits.kiloK**-3,
            ...
            cobj.cp_mol_liq_comp_coeff_E = Var(
                doc="Shomate E parameter for ideal liquid molar heat capacity",
                units=pyunits.J
                * pyunits.mol**-1
                * pyunits.K**-1
                * pyunits.kiloK**2,
            ...
            cobj.cp_mol_liq_comp_coeff_F = Var(
                doc="Shomate F parameter for ideal liquid molar heat capacity",
                units=pyunits.kJ * pyunits.mol**-1,
            )
            set_param_from_config(cobj, param="cp_mol_liq_comp_coeff", index="F")

            cobj.cp_mol_liq_comp_coeff_G = Var(
                doc="Shomate G parameter for ideal liquid molar heat capacity",
                units=pyunits.J * pyunits.mol**-1 * pyunits.K**-1,
            )
            set_param_from_config(cobj, param="cp_mol_liq_comp_coeff", index="G")

            cobj.cp_mol_liq_comp_coeff_H = Var(
                doc="Shomate H parameter for ideal liquid molar heat capacity",
                units=pyunits.kJ * pyunits.mol**-1,
            )
            set_param_from_config(cobj, param="cp_mol_liq_comp_coeff", index="H")
            ...
            cobj.enth_mol_form_vap_comp_ref = Expression(
                expr=pyunits.convert(
                    cobj.cp_mol_liq_comp_coeff_H, to_units=units.ENERGY_MOLE
                ),
                doc="Vapor phase molar heat of formation @ Tref",
            )
        ...
        def return_expression(b, cobj, T):
            ...
            cp = (
                ...
                + cobj.cp_mol_liq_comp_coeff_C * t**2
                + cobj.cp_mol_liq_comp_coeff_D * t**3
    ...
    class enth_mol_liq_comp:
        ...
        def build_parameters(cobj):
            if not hasattr(cobj, "cp_mol_liq_comp_coeff_A"):
                NIST.cp_mol_liq_comp.build_parameters(cobj)
        ...
        def return_expression(b, cobj, T):
            ...
            h = (
                ...
                + (cobj.cp_mol_liq_comp_coeff_B / 2) * t**2
                + (cobj.cp_mol_liq_comp_coeff_C / 3) * t**3
                + (cobj.cp_mol_liq_comp_coeff_D / 4) * t**4
                - cobj.cp_mol_liq_comp_coeff_E / t
                + cobj.cp_mol_liq_comp_coeff_F
                - H
            )
    ...
    class entr_mol_liq_comp:
        ...
        def return_expression(b, cobj, T):
            ...
            s = (
                cobj.cp_mol_liq_comp_coeff_A * log(t / pyunits.kiloK)
                + cobj.cp_mol_liq_comp_coeff_B * t  # need to make unitless
                + (cobj.cp_mol_liq_comp_coeff_C / 2) * t**2
                + (cobj.cp_mol_liq_comp_coeff_D / 3) * t**3
                - (cobj.cp_mol_liq_comp_coeff_E / 2) * t**-2
                + cobj.cp_mol_liq_comp_coeff_G
            )
